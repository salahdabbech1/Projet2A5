...
{
    QSqlQuery query;
    query.prepare("insert into contrat(ref,idemp,salaire,datedebut,datefin)values(:ref,:idemp,:salaire,:date_debut,:date_fin)");
...
bool contrat::update(QDate date_fin, int salaire,int idemp)
{
    QSqlQuery query;
    QString res=QString::number(idemp);
